...
#+BEGIN_SRC emacs-lisp
  (when (equal system-type 'darwin)
    ...
    (setenv "PATH" (concat (getenv "PATH") ":/Library/TeX/texbin:/usr/local/bin/:$HOME/.pyenv/shims:$HOME/.local/bin/"))
    (setenv "PATH" (concat (getenv "PATH") ":/Library/TeX/texbin:/usr/local/bin/:/Users/miguelescalante/src/miniconda3/bin/:/opt/homebrew/bin/:/opt/homebrew/sbin/:/opt/homebrew/opt/libpq/bin"))
