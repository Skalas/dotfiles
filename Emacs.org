      ...
      (progn
        (defvar my-keys-minor-mode-map
          (let ((map (make-sparse-keymap)))
            (define-key map (kbd "<M-s-up>") 'window-jump-up)
            (define-key map (kbd "<M-s-right>") 'window-jump-right)
            (define-key map (kbd "<M-s-down>") 'window-jump-down)
            (define-key map (kbd "<M-s-left>") 'window-jump-left)
            map)
